...
class LogisticRegression:
  ...
  def Regression(self,iter,LR,theta):
    ...
    theta_h,error = self.GD(iter,LR,theta)
...
theta_h,error = p.Regression(100,0.00001,theta)##(iter,learning rate)
